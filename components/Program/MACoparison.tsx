          ...
          <table className="w-full bg-white rounded-lg overflow-hidden shadow-sm">
            <thead>
              <tr className="bg-primary">
                <th className="p-4 sm:p-6 text-left font-neutiva font-bold text-sm sm:text-base text-primary">
                  Feature/ Capability
                </th>
                <th className="p-4 sm:p-6 text-center font-neutiva font-bold text-sm sm:text-base text-primary">
