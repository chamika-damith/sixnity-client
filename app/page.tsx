...
export default function Home() {
  return (
    <div className="">
      ...
      <div className="relative w-full lg:h-[70vh] xl:h-[90vh] 2xl:h-[90vh]  bg-primary-gradient rounded-lg my-0 sm:my-0 md:my-0 lg:mb-4 xl:mb-4 2xl:my-0 flex flex-col justify-end overflow-hidden">
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-5 gap-0 sm:gap-0 md:gap-0 lg:gap-2 xl:gap-2 2xl:gap-4 items-end  lg:pl-8 xl:pl-10 2xl:pl-10">
          <div className="col-span-1 lg:col-span-2 px-6 lg:px-0   w-full h-full py-6  md:px-6">
            <div>
